...
beginInitialization = () => {
    ...
    setTimeout(() => window.ove.frame.send(Constants.Frame.PARENT, { cull: { sectionId: OVE.Utils.getSectionId() } }, 'core'), Constants.FRAME_LOAD_DELAY);
};
