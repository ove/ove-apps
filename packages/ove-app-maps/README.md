...
3. The [Map Layers configuration](../ove-app-maps/docs/MAP_LAYERS_JSON.md) must be available (unless it is embedded in `config.json`) before the server-side of this app is launched using PM2 or Docker.
